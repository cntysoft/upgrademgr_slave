...
using umslib::network::MultiThreadServer;
using umslib::network::set_global_server;
using sn::corelib::network::WebServiceServer;

using upgrademgr::slave::Application;
using upgrademgr::slave::get_app_ref;
