...
class UMS_LIB_EXPORT MultiThreadServer : public AbstractMultiThreadServer
{
public:
...
UMS_LIB_EXPORT MultiThreadServer*& get_global_server();
UMS_LIB_EXPORT void set_global_server(MultiThreadServer* server);
